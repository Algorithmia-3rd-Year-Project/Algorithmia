...
public class LinkedListLine : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            startPointName = startPos.transform.parent.parent.GetComponent<LinkedListBlock>().blockName;
            endPointName = endPos.transform.parent.parent.GetComponent<LinkedListBlock>().blockName;
