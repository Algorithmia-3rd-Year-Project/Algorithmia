...
public class StackLine : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            startPointName = startPos.transform.parent.parent.GetComponent<StackBlock>().blockName;

            if (endPos.name == "Shooter")
            {
                endPointName = "Machine";
            }
            else
            {
                endPointName = endPos.transform.parent.parent.GetComponent<StackBlock>().blockName;
            }
