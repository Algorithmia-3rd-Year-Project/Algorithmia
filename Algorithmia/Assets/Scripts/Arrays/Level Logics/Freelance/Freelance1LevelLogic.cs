...
public class Freelance1LevelLogic: MonoBehaviour
{
    ...
    public string OptimalAnswer()
    {
        ...
        else
        {
            ...
            string[] currentArray = new string[5];
            ...
            for (int i = 0; i < levelManager.blocks.Count; i++)
            {
                if (levelManager.blocks[i].name == "Advanced Array Block")
                {
    ...
    private void VictoryMenuDetails()
    {
        ...
        {
            if (outputArray[0] == "AKQJ" && currentTime <= 30f)
            {
            ...
            } else if (outputArray[0] == "AKQJ" && currentTime <= 60f)
            {
