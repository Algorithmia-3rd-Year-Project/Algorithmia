...
public class ArrayAssignmentLevelLogic : MonoBehaviour
{
    ...
    private void VictoryMenuDetails()
    {
        ...
        {
            if (outputArray[0] == "lived" && currentTime <= 30f)
            {
            ...
            } else if (outputArray[0] == "lived" && currentTime <= 60f)
            {
            ...
            else
            {
                ...
                resultMsg.text = outputArray[0];
                objectiveStatus.text = "Objective incomplete";
